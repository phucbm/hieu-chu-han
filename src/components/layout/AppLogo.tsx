        ...
        <div className="flex flex-col gap-0.5">
            <div className="flex justify-between items-baseline">
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/phucbm/hieu-chu-han" aria-label="GitHub" className="hover:text-foreground transition-colors">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://discord.gg/Wnckq2KE" aria-label="Discord" className="hover:text-foreground transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
