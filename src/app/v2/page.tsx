...
import { HchSidebar } from "./components/hch-sidebar"
import { V2SearchDialog } from "./components/v2-search-dialog"
import { V2RightSheet } from "./components/v2-right-sheet"
import { V2ContentArea } from "./components/v2-content-area"
...
export default function V2Page() {
  ...
  // ── openWord — single navigation handler ─────────────────────────────────
  ...
  // Stable ref so mount effect uses latest openWord
  const openWordRef = useRef(openWord)
  openWordRef.current = openWord

  // ── Restore ?word= on first mount ────────────────────────────────────────
  useEffect(() => {
