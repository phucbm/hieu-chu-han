...
**[character]** ([pinyin]) - Hán Việt: *[Sino-Vietnamese reading]*

- Bộ thủ / thành phần: [radical and components — e.g. 鲜 contains 鱼 (ngư/fish) and 羊 (dương/goat); 国 is simplified from 國, built from 囗 (vi, enclosure) and 或 (huò, phonetic)]
- Nghĩa gốc: [core meaning of this character]
- Ví dụ Hán Việt quen thuộc: [3–5 common Sino-Vietnamese compounds containing this character, with meaning — e.g. tân niên/新年/năm mới]

### Liên tưởng để nhớ

[2–4 sentences in Vietnamese, poetic and vivid, weaving the meanings of each character into a single image or story that evokes the full word's meaning. Avoid dry explanation.]
